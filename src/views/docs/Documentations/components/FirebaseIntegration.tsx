...
const FirebaseIntegration = () => {
    return (
        <>
            ...
            <p>
                While our template doesn't have Firebase integration pre-built,
                we've noticed a high demand from our customers for it. As a
                result, we've put together a straightforward auth integration
                tutorial to help you seamlessly incorporate Firebase into the
                template.
            </p>
                ...
                <ul className="mt-1">
                    <li>
                        ...
                        <ol>
                            ...
                            <li>
                                Once the project is created, click on the "Web"
    ...
    return await signOut(auth).then(user => user).catch(err => err);
                    ...
                    <li>
                        <p>
                            ...
                            <code>username</code> as a credential, you'll need
                            to make adjustments to the input and schema in{' '}
                            <code>SignInForm.tsx</code>,{' '}
                            <code>SignUpForm.tsx</code> &{' '}
                            <code>@types/auth.ts</code>. Below, you'll find the
                            updated code that you can use to replace them.
                        </p>
        ...
        <div className={className}>
            ...
            <div className="mt-10" id="conclusion">
                ...
                <p>
                    ...
                    functionality and user experience along with Mobility.
                </p>
                <p>
